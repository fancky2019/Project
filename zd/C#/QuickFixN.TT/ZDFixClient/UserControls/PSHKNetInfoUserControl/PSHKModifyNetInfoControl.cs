...
{
    public partial class PSHKModifyNetInfoControl : ModifyNetInfoControl
    {
        public event Action<ModifyInfo,string, string> ModifyOrder;
        public PSHKModifyNetInfoControl()
        {
            InitializeComponent();
        }
        ...
        private void btnAmendOrder_Click(object sender, EventArgs e)
        {
            ...
            ModifyOrder?.Invoke(modifyInfo, this.txtAmendSysCode.Text.Trim(), CommandCode.ModifyStockHK);
        }
        #endregion
    }
}
