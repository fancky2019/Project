...
namespace QuickFix
{
    namespace FIX50 
    {
        public class MarketDataSnapshotFullRefresh : Message
        {
            ...
            public QuickFix.Fields.RefreshIndicator RefreshIndicator
            { 
                get 
                {
                    QuickFix.Fields.RefreshIndicator val = new QuickFix.Fields.RefreshIndicator();
                    GetField(val);
                    return val;
                }
                set { SetField(value); }
            ...
            public void Set(QuickFix.Fields.RefreshIndicator val) 
            { 
                this.RefreshIndicator = val;
            }
            
            public QuickFix.Fields.RefreshIndicator Get(QuickFix.Fields.RefreshIndicator val) 
            { 
                GetField(val);
                return val;
            }
            
            public bool IsSet(QuickFix.Fields.RefreshIndicator val) 
            { 
                return IsSetRefreshIndicator();
            }
            
            public bool IsSetRefreshIndicator() 
            { 
                return IsSetField(Tags.RefreshIndicator);
            }
            ...
            {
                public static int[] fieldOrder = {Tags.MDEntryType, Tags.MDEntryID, Tags.MDEntryPx, Tags.PriceType, Tags.YieldType, Tags.Yield, Tags.YieldCalcDate, Tags.YieldRedemptionDate, Tags.YieldRedemptionPrice, Tags.YieldRedemptionPriceType, Tags.Spread, Tags.BenchmarkCurveCurrency, Tags.BenchmarkCurveName, Tags.BenchmarkCurvePoint, Tags.BenchmarkPrice, Tags.BenchmarkPriceType, Tags.BenchmarkSecurityID, Tags.BenchmarkSecurityIDSource, Tags.OrdType, Tags.Currency, Tags.MDEntrySize, Tags.NoOfSecSizes, Tags.LotType, Tags.MDEntryDate, Tags.MDEntryTime, Tags.TickDirection, Tags.MDMkt, Tags.TradingSessionID, Tags.TradingSessionSubID, Tags.SecurityTradingStatus, Tags.HaltReasonInt, Tags.QuoteCondition, Tags.TradeCondition, Tags.MDEntryOriginator, Tags.LocationID, Tags.DeskID, Tags.OpenCloseSettlFlag, Tags.TimeInForce, Tags.ExpireDate, Tags.ExpireTime, Tags.MinQty, Tags.ExecInst, Tags.SellerDays, Tags.OrderID, Tags.SecondaryOrderID, Tags.QuoteEntryID, Tags.MDEntryBuyer, Tags.MDEntrySeller, Tags.NumberOfOrders, Tags.MDEntryPositionNo, Tags.Scope, Tags.PriceDelta, Tags.Text, Tags.EncodedTextLen, Tags.EncodedText, Tags.MDPriceLevel, Tags.OrderCapacity, Tags.MDOriginType, Tags.HighPx, Tags.LowPx, Tags.TradeVolume, Tags.SettlType, Tags.SettlDate, Tags.MDQuoteType, Tags.RptSeq, Tags.DealingCapacity, Tags.MDEntrySpotRate, Tags.MDEntryForwardPoints, Tags.NoPartyIDs, Tags.SettlCurrency, Tags.NoRateSources, Tags.TrdType, Tags.FirstPx, Tags.LastPx, 0};
