    ...
    namespace FIX50 
    {
        public class TradeCaptureReport : Message
        {
            ...
            { 
                get 
                {
                    QuickFix.Fields.VenueType val = new QuickFix.Fields.VenueType();
                    GetField(val);
                    return val;
                }
                set { SetField(value); }
            ...
            { 
                return IsSetField(Tags.VenueType);
            }
            ...
            {
                public static int[] fieldOrder = {Tags.Side, Tags.SideLastQty, Tags.SideTradeReportID, Tags.SideFillStationCd, Tags.SideReasonCd, Tags.RptSeq, Tags.SideTrdSubTyp, Tags.NetGrossInd, Tags.SideCurrency, Tags.SideSettlCurrency, Tags.NoPartyIDs, Tags.Account, Tags.AcctIDSource, Tags.AccountType, Tags.ProcessCode, Tags.OddLot, Tags.NoClearingInstructions, Tags.TradeInputSource, Tags.TradeInputDevice, Tags.ComplianceID, Tags.SolicitedFlag, Tags.CustOrderCapacity, Tags.TradingSessionID, Tags.TradingSessionSubID, Tags.TimeBracket, Tags.Commission, Tags.CommType, Tags.CommCurrency, Tags.FundRenewWaiv, Tags.NumDaysInterest, Tags.ExDate, Tags.AccruedInterestRate, Tags.AccruedInterestAmt, Tags.InterestAtMaturity, Tags.EndAccruedInterestAmt, Tags.StartCash, Tags.EndCash, Tags.Concession, Tags.TotalTakedown, Tags.NetMoney, Tags.SettlCurrAmt, Tags.SettlCurrFxRate, Tags.SettlCurrFxRateCalc, Tags.PositionEffect, Tags.Text, Tags.EncodedTextLen, Tags.EncodedText, Tags.SideMultiLegReportingType, Tags.NoContAmts, Tags.NoStipulations, Tags.NoMiscFees, Tags.ExchangeRule, Tags.TradeAllocIndicator, Tags.PreallocMethod, Tags.AllocID, Tags.NoAllocs, Tags.NoSideTrdRegTS, Tags.NoSettlDetails, Tags.SideGrossTradeAmt, Tags.AggressorIndicator, Tags.ExchangeSpecialInstructions, Tags.OrderCategory, Tags.OrderID, Tags.SecondaryOrderID, Tags.ClOrdID, Tags.SecondaryClOrdID, Tags.ListID, Tags.RefOrderID, Tags.RefOrderIDSource, Tags.RefOrdIDReason, Tags.OrdType, Tags.Price, Tags.StopPx, Tags.ExecInst, Tags.OrdStatus, Tags.OrderQty, Tags.CashOrderQty, Tags.OrderPercent, Tags.RoundingDirection, Tags.RoundingModulus, Tags.LeavesQty, Tags.CumQty, Tags.TimeInForce, Tags.ExpireTime, Tags.DisplayQty, Tags.SecondaryDisplayQty, Tags.DisplayWhen, Tags.DisplayMethod, Tags.DisplayLowQty, Tags.DisplayHighQty, Tags.DisplayMinIncr, Tags.RefreshQty, Tags.OrderCapacity, Tags.OrderRestrictions, Tags.OrigCustOrderCapacity, Tags.OrderInputDevice, Tags.LotType, Tags.TransBkdTime, Tags.OrigOrdModTime, Tags.BookingType, Tags.SideExecID, Tags.OrderDelay, Tags.OrderDelayUnit, Tags.SideLiquidityInd, 0};
                ...
                { 
                    get 
                    {
                        QuickFix.Fields.SideLastQty val = new QuickFix.Fields.SideLastQty();
                        GetField(val);
                        return val;
                    }
                    set { SetField(value); }
                ...
                { 
                    return IsSetField(Tags.SideLastQty);
                }
                ...
                { 
                    get 
                    {
                        QuickFix.Fields.RefOrdIDReason val = new QuickFix.Fields.RefOrdIDReason();
                        GetField(val);
                        return val;
                    }
                    set { SetField(value); }
                ...
                { 
                    return IsSetField(Tags.RefOrdIDReason);
                }
                ...
                { 
                    get 
                    {
                        QuickFix.Fields.OrigCustOrderCapacity val = new QuickFix.Fields.OrigCustOrderCapacity();
                        GetField(val);
                        return val;
                    }
                    set { SetField(value); }
                ...
                { 
                    this.OrigCustOrderCapacity = val;
                }
                ...
                { 
                    return IsSetField(Tags.OrigCustOrderCapacity);
                }
                ...
                { 
                    get 
                    {
                        QuickFix.Fields.SideExecID val = new QuickFix.Fields.SideExecID();
                        GetField(val);
                        return val;
                    }
                    set { SetField(value); }
                ...
                { 
                    return IsSetField(Tags.SideExecID);
                }
                public QuickFix.Fields.OrderDelay OrderDelay
                { 
                    get 
                    {
                        QuickFix.Fields.OrderDelay val = new QuickFix.Fields.OrderDelay();
                        GetField(val);
                        return val;
                    }
                    set { SetField(value); }
                ...
                { 
                    return IsSetField(Tags.OrderDelay);
                }
                public QuickFix.Fields.OrderDelayUnit OrderDelayUnit
                { 
                    get 
                    {
                        QuickFix.Fields.OrderDelayUnit val = new QuickFix.Fields.OrderDelayUnit();
                        GetField(val);
                        return val;
                    }
                    set { SetField(value); }
                ...
                { 
                    return IsSetField(Tags.OrderDelayUnit);
                }
                public QuickFix.Fields.SideLiquidityInd SideLiquidityInd
                { 
                    get 
                    {
                        QuickFix.Fields.SideLiquidityInd val = new QuickFix.Fields.SideLiquidityInd();
                        GetField(val);
                        return val;
                    }
                    set { SetField(value); }
                ...
                public void Set(QuickFix.Fields.SideLiquidityInd val) 
                { 
                    this.SideLiquidityInd = val;
                }
                ...
                public bool IsSet(QuickFix.Fields.SideLiquidityInd val) 
                { 
                    return IsSetSideLiquidityInd();
                }
                
                public bool IsSetSideLiquidityInd() 
                { 
                    return IsSetField(Tags.SideLiquidityInd);
                }
