        ...
        public class MassQuoteAcknowledgement : Message
        {
            ...
            public class NoQuoteSetsGroup : Group
            {
                ...
                { 
                    get 
                    {
                        QuickFix.Fields.TotNoCxldQuotes val = new QuickFix.Fields.TotNoCxldQuotes();
                        GetField(val);
                        return val;
                    }
                    set { SetField(value); }
                ...
                public void Set(QuickFix.Fields.TotNoCxldQuotes val) 
                { 
                    this.TotNoCxldQuotes = val;
                }
                ...
                public bool IsSet(QuickFix.Fields.TotNoCxldQuotes val) 
                { 
                    return IsSetTotNoCxldQuotes();
                }
                
                public bool IsSetTotNoCxldQuotes() 
                { 
                    return IsSetField(Tags.TotNoCxldQuotes);
                }
                public QuickFix.Fields.TotNoAccQuotes TotNoAccQuotes
                { 
                    get 
                    {
                        QuickFix.Fields.TotNoAccQuotes val = new QuickFix.Fields.TotNoAccQuotes();
                        GetField(val);
                        return val;
                    }
                    set { SetField(value); }
                ...
                public void Set(QuickFix.Fields.TotNoAccQuotes val) 
                { 
                    this.TotNoAccQuotes = val;
                }
                ...
                public bool IsSet(QuickFix.Fields.TotNoAccQuotes val) 
                { 
                    return IsSetTotNoAccQuotes();
                }
                
                public bool IsSetTotNoAccQuotes() 
                { 
                    return IsSetField(Tags.TotNoAccQuotes);
                }
                public QuickFix.Fields.TotNoRejQuotes TotNoRejQuotes
                { 
                    get 
                    {
                        QuickFix.Fields.TotNoRejQuotes val = new QuickFix.Fields.TotNoRejQuotes();
                        GetField(val);
                        return val;
                    }
                    set { SetField(value); }
                ...
                public void Set(QuickFix.Fields.TotNoRejQuotes val) 
                { 
                    this.TotNoRejQuotes = val;
                }
                ...
                public bool IsSet(QuickFix.Fields.TotNoRejQuotes val) 
                { 
                    return IsSetTotNoRejQuotes();
                }
                
                public bool IsSetTotNoRejQuotes() 
                { 
                    return IsSetField(Tags.TotNoRejQuotes);
                }
                ...
                public class NoQuoteEntriesGroup : Group
                {
                    ...
                    { 
                        get 
                        {
                            QuickFix.Fields.QuoteEntryStatus val = new QuickFix.Fields.QuoteEntryStatus();
                            GetField(val);
                            return val;
                        }
                        set { SetField(value); }
                    ...
                    public void Set(QuickFix.Fields.QuoteEntryStatus val) 
                    { 
                        this.QuoteEntryStatus = val;
                    }
                    ...
                    public bool IsSet(QuickFix.Fields.QuoteEntryStatus val) 
                    { 
                        return IsSetQuoteEntryStatus();
                    }
                    
                    public bool IsSetQuoteEntryStatus() 
                    { 
                        return IsSetField(Tags.QuoteEntryStatus);
                    }
