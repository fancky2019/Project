...
namespace QuickFix
{
    namespace FIX50 
    {
        public class OrderCancelReplaceRequest : Message
        {
            ...
            public QuickFix.Fields.NoDisclosureInstructions NoDisclosureInstructions
            { 
                get 
                {
                    QuickFix.Fields.NoDisclosureInstructions val = new QuickFix.Fields.NoDisclosureInstructions();
                    GetField(val);
                    return val;
                }
                set { SetField(value); }
            ...
            public void Set(QuickFix.Fields.NoDisclosureInstructions val) 
            { 
                this.NoDisclosureInstructions = val;
            }
            
            public QuickFix.Fields.NoDisclosureInstructions Get(QuickFix.Fields.NoDisclosureInstructions val) 
            { 
                GetField(val);
                return val;
            }
            
            public bool IsSet(QuickFix.Fields.NoDisclosureInstructions val) 
            { 
                return IsSetNoDisclosureInstructions();
            }
            
            public bool IsSetNoDisclosureInstructions() 
            { 
                return IsSetField(Tags.NoDisclosureInstructions);
            }
            ...
            public class NoDisclosureInstructionsGroup : Group
            {
                public static int[] fieldOrder = {Tags.DisclosureType, Tags.DisclosureInstruction, 0};
            
                public NoDisclosureInstructionsGroup() 
                  :base( Tags.NoDisclosureInstructions, Tags.DisclosureType, fieldOrder)
                {
                }
            
                public override Group Clone()
                {
                    var clone = new NoDisclosureInstructionsGroup();
                    clone.CopyStateFrom(this);
                    return clone;
                }
            
                            public QuickFix.Fields.DisclosureType DisclosureType
                { 
                    get 
                    {
                        QuickFix.Fields.DisclosureType val = new QuickFix.Fields.DisclosureType();
                        GetField(val);
                        return val;
                    }
                    set { SetField(value); }
                ...
                public void Set(QuickFix.Fields.DisclosureType val) 
                { 
                    this.DisclosureType = val;
                }
                
                public QuickFix.Fields.DisclosureType Get(QuickFix.Fields.DisclosureType val) 
                { 
                    GetField(val);
                    return val;
                }
                
                public bool IsSet(QuickFix.Fields.DisclosureType val) 
                { 
                    return IsSetDisclosureType();
                }
                
                public bool IsSetDisclosureType() 
                { 
                    return IsSetField(Tags.DisclosureType);
                }
                public QuickFix.Fields.DisclosureInstruction DisclosureInstruction
                { 
                    get 
                    {
                        QuickFix.Fields.DisclosureInstruction val = new QuickFix.Fields.DisclosureInstruction();
                        GetField(val);
                        return val;
                    }
                    set { SetField(value); }
                ...
                public void Set(QuickFix.Fields.DisclosureInstruction val) 
                { 
                    this.DisclosureInstruction = val;
                }
                
                public QuickFix.Fields.DisclosureInstruction Get(QuickFix.Fields.DisclosureInstruction val) 
                { 
                    GetField(val);
                    return val;
                }
                
                public bool IsSet(QuickFix.Fields.DisclosureInstruction val) 
                { 
                    return IsSetDisclosureInstruction();
                }
                
                public bool IsSetDisclosureInstruction() 
                { 
                    return IsSetField(Tags.DisclosureInstruction);
                }
