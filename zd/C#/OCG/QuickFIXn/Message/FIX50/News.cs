...
namespace QuickFix
{
    namespace FIX50 
    {
        public class News : Message
        {
            ...
            public QuickFix.Fields.NewsID NewsID
            { 
                get 
                {
                    QuickFix.Fields.NewsID val = new QuickFix.Fields.NewsID();
                    GetField(val);
                    return val;
                }
                set { SetField(value); }
            ...
            public void Set(QuickFix.Fields.NewsID val) 
            { 
                this.NewsID = val;
            }
            
            public QuickFix.Fields.NewsID Get(QuickFix.Fields.NewsID val) 
            { 
                GetField(val);
                return val;
            }
            
            public bool IsSet(QuickFix.Fields.NewsID val) 
            { 
                return IsSetNewsID();
            }
            
            public bool IsSetNewsID() 
            { 
                return IsSetField(Tags.NewsID);
            }
            public QuickFix.Fields.NoNewsRefIDs NoNewsRefIDs
            { 
                get 
                {
                    QuickFix.Fields.NoNewsRefIDs val = new QuickFix.Fields.NoNewsRefIDs();
                    GetField(val);
                    return val;
                }
                set { SetField(value); }
            ...
            public void Set(QuickFix.Fields.NoNewsRefIDs val) 
            { 
                this.NoNewsRefIDs = val;
            }
            
            public QuickFix.Fields.NoNewsRefIDs Get(QuickFix.Fields.NoNewsRefIDs val) 
            { 
                GetField(val);
                return val;
            }
            
            public bool IsSet(QuickFix.Fields.NoNewsRefIDs val) 
            { 
                return IsSetNoNewsRefIDs();
            }
            
            public bool IsSetNoNewsRefIDs() 
            { 
                return IsSetField(Tags.NoNewsRefIDs);
            }
            public QuickFix.Fields.NewsCategory NewsCategory
            { 
                get 
                {
                    QuickFix.Fields.NewsCategory val = new QuickFix.Fields.NewsCategory();
                    GetField(val);
                    return val;
                }
                set { SetField(value); }
            ...
            public void Set(QuickFix.Fields.NewsCategory val) 
            { 
                this.NewsCategory = val;
            }
            
            public QuickFix.Fields.NewsCategory Get(QuickFix.Fields.NewsCategory val) 
            { 
                GetField(val);
                return val;
            }
            
            public bool IsSet(QuickFix.Fields.NewsCategory val) 
            { 
                return IsSetNewsCategory();
            }
            
            public bool IsSetNewsCategory() 
            { 
                return IsSetField(Tags.NewsCategory);
            }
            public QuickFix.Fields.LanguageCode LanguageCode
            { 
                get 
                {
                    QuickFix.Fields.LanguageCode val = new QuickFix.Fields.LanguageCode();
                    GetField(val);
                    return val;
                }
                set { SetField(value); }
            ...
            public void Set(QuickFix.Fields.LanguageCode val) 
            { 
                this.LanguageCode = val;
            }
            
            public QuickFix.Fields.LanguageCode Get(QuickFix.Fields.LanguageCode val) 
            { 
                GetField(val);
                return val;
            }
            
            public bool IsSet(QuickFix.Fields.LanguageCode val) 
            { 
                return IsSetLanguageCode();
            }
            
            public bool IsSetLanguageCode() 
            { 
                return IsSetField(Tags.LanguageCode);
            }
            ...
            {
                public static int[] fieldOrder = {Tags.Symbol, Tags.SymbolSfx, Tags.SecurityID, Tags.SecurityIDSource, Tags.NoSecurityAltID, Tags.Product, Tags.ProductComplex, Tags.SecurityGroup, Tags.CFICode, Tags.SecurityType, Tags.SecuritySubType, Tags.MaturityMonthYear, Tags.MaturityDate, Tags.MaturityTime, Tags.SettleOnOpenFlag, Tags.InstrmtAssignmentMethod, Tags.SecurityStatus, Tags.CouponPaymentDate, Tags.IssueDate, Tags.RepoCollateralSecurityType, Tags.RepurchaseTerm, Tags.RepurchaseRate, Tags.Factor, Tags.CreditRating, Tags.InstrRegistry, Tags.CountryOfIssue, Tags.StateOrProvinceOfIssue, Tags.LocaleOfIssue, Tags.RedemptionDate, Tags.StrikePrice, Tags.StrikeCurrency, Tags.StrikeMultiplier, Tags.StrikeValue, Tags.OptAttribute, Tags.ContractMultiplier, Tags.MinPriceIncrement, Tags.MinPriceIncrementAmount, Tags.UnitOfMeasure, Tags.UnitOfMeasureQty, Tags.PriceUnitOfMeasure, Tags.PriceUnitOfMeasureQty, Tags.SettlMethod, Tags.ExerciseStyle, Tags.OptPayoutAmount, Tags.PriceQuoteMethod, Tags.ValuationMethod, Tags.ListMethod, Tags.CapPrice, Tags.FloorPrice, Tags.PutOrCall, Tags.FlexibleIndicator, Tags.FlexProductEligibilityIndicator, Tags.TimeUnit, Tags.CouponRate, Tags.SecurityExchange, Tags.PositionLimit, Tags.NTPositionLimit, Tags.Issuer, Tags.EncodedIssuerLen, Tags.EncodedIssuer, Tags.SecurityDesc, Tags.EncodedSecurityDescLen, Tags.EncodedSecurityDesc, Tags.SecurityXMLLen, Tags.SecurityXML, Tags.SecurityXMLSchema, Tags.Pool, Tags.ContractSettlMonth, Tags.CPProgram, Tags.CPRegType, Tags.NoEvents, Tags.DatedDate, Tags.InterestAccrualDate, Tags.NoInstrumentParties, Tags.ContractMultiplierUnit, Tags.FlowScheduleType, Tags.RestructuringType, Tags.Seniority, Tags.NotionalPercentageOutstanding, Tags.OriginalNotionalPercentageOutstanding, Tags.AttachmentPoint, Tags.DetachmentPoint, Tags.StrikePriceDeterminationMethod, Tags.StrikePriceBoundaryMethod, Tags.StrikePriceBoundaryPrecision, Tags.UnderlyingPriceDeterminationMethod, Tags.OptPayoutType, Tags.NoComplexEvents, 0};
            ...
            public class NoNewsRefIDsGroup : Group
            {
                public static int[] fieldOrder = {Tags.NewsRefID, Tags.NewsRefType, 0};
            
                public NoNewsRefIDsGroup() 
                  :base( Tags.NoNewsRefIDs, Tags.NewsRefID, fieldOrder)
                {
                }
            
                public override Group Clone()
                {
                    var clone = new NoNewsRefIDsGroup();
                    clone.CopyStateFrom(this);
                    return clone;
                }
            
                            public QuickFix.Fields.NewsRefID NewsRefID
                { 
                    get 
                    {
                        QuickFix.Fields.NewsRefID val = new QuickFix.Fields.NewsRefID();
                        GetField(val);
                        return val;
                    }
                    set { SetField(value); }
                ...
                public void Set(QuickFix.Fields.NewsRefID val) 
                { 
                    this.NewsRefID = val;
                }
                
                public QuickFix.Fields.NewsRefID Get(QuickFix.Fields.NewsRefID val) 
                { 
                    GetField(val);
                    return val;
                }
                
                public bool IsSet(QuickFix.Fields.NewsRefID val) 
                { 
                    return IsSetNewsRefID();
                }
                
                public bool IsSetNewsRefID() 
                { 
                    return IsSetField(Tags.NewsRefID);
                }
                public QuickFix.Fields.NewsRefType NewsRefType
                { 
                    get 
                    {
                        QuickFix.Fields.NewsRefType val = new QuickFix.Fields.NewsRefType();
                        GetField(val);
                        return val;
                    }
                    set { SetField(value); }
                ...
                public void Set(QuickFix.Fields.NewsRefType val) 
                { 
                    this.NewsRefType = val;
                }
                
                public QuickFix.Fields.NewsRefType Get(QuickFix.Fields.NewsRefType val) 
                { 
                    GetField(val);
                    return val;
                }
                
                public bool IsSet(QuickFix.Fields.NewsRefType val) 
                { 
                    return IsSetNewsRefType();
                }
                
                public bool IsSetNewsRefType() 
                { 
                    return IsSetField(Tags.NewsRefType);
                }
