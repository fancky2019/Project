...
namespace QuickFix
{
    namespace FIX50 
    {
        public class ListStatus : Message
        {
            ...
            {
                public static int[] fieldOrder = {Tags.ClOrdID, Tags.OrderID, Tags.SecondaryClOrdID, Tags.CumQty, Tags.OrdStatus, Tags.WorkingIndicator, Tags.LeavesQty, Tags.CxlQty, Tags.AvgPx, Tags.OrdRejReason, Tags.Text, Tags.EncodedTextLen, Tags.EncodedText, 0};
