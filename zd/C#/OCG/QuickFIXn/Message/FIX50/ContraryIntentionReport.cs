    ...
    namespace FIX50 
    {
        public class ContraryIntentionReport : Message
        {
            ...
            { 
                get 
                {
                    QuickFix.Fields.ContIntRptID val = new QuickFix.Fields.ContIntRptID();
                    GetField(val);
                    return val;
                }
                set { SetField(value); }
            ...
            public void Set(QuickFix.Fields.ContIntRptID val) 
            { 
                this.ContIntRptID = val;
            }
            ...
            public bool IsSet(QuickFix.Fields.ContIntRptID val) 
            { 
                return IsSetContIntRptID();
            }
            
            public bool IsSetContIntRptID() 
            { 
                return IsSetField(Tags.ContIntRptID);
            }
            ...
            { 
                get 
                {
                    QuickFix.Fields.LateIndicator val = new QuickFix.Fields.LateIndicator();
                    GetField(val);
                    return val;
                }
                set { SetField(value); }
            ...
            public void Set(QuickFix.Fields.LateIndicator val) 
            { 
                this.LateIndicator = val;
            }
            ...
            public bool IsSet(QuickFix.Fields.LateIndicator val) 
            { 
                return IsSetLateIndicator();
            }
            
            public bool IsSetLateIndicator() 
            { 
                return IsSetField(Tags.LateIndicator);
            }
            public QuickFix.Fields.InputSource InputSource
            { 
                get 
                {
                    QuickFix.Fields.InputSource val = new QuickFix.Fields.InputSource();
                    GetField(val);
                    return val;
                }
                set { SetField(value); }
            ...
            public void Set(QuickFix.Fields.InputSource val) 
            { 
                this.InputSource = val;
            }
            ...
            public bool IsSet(QuickFix.Fields.InputSource val) 
            { 
                return IsSetInputSource();
            }
            
            public bool IsSetInputSource() 
            { 
                return IsSetField(Tags.InputSource);
            }
            ...
            { 
                get 
                {
                    QuickFix.Fields.NoExpiration val = new QuickFix.Fields.NoExpiration();
                    GetField(val);
                    return val;
                }
                set { SetField(value); }
            ...
            public void Set(QuickFix.Fields.NoExpiration val) 
            { 
                this.NoExpiration = val;
            }
            ...
            public bool IsSet(QuickFix.Fields.NoExpiration val) 
            { 
                return IsSetNoExpiration();
            }
            
            public bool IsSetNoExpiration() 
            { 
                return IsSetField(Tags.NoExpiration);
            }
            ...
            {
                public static int[] fieldOrder = {Tags.ExpirationQtyType, Tags.ExpQty, 0};
            
                public NoExpirationGroup() 
                  :base( Tags.NoExpiration, Tags.ExpirationQtyType, fieldOrder)
                {
                }
                ...
                public override Group Clone()
                {
                    ...
                    return clone;
                            ...
                            public QuickFix.Fields.ExpirationQtyType ExpirationQtyType
                { 
                    get 
                    {
                        QuickFix.Fields.ExpirationQtyType val = new QuickFix.Fields.ExpirationQtyType();
                        GetField(val);
                        return val;
                    }
                    set { SetField(value); }
                ...
                public void Set(QuickFix.Fields.ExpirationQtyType val) 
                { 
                    this.ExpirationQtyType = val;
                }
                
                public QuickFix.Fields.ExpirationQtyType Get(QuickFix.Fields.ExpirationQtyType val) 
                { 
                    GetField(val);
                    return val;
                }
                
                public bool IsSet(QuickFix.Fields.ExpirationQtyType val) 
                { 
                    return IsSetExpirationQtyType();
                }
                
                public bool IsSetExpirationQtyType() 
                { 
                    return IsSetField(Tags.ExpirationQtyType);
                }
                public QuickFix.Fields.ExpQty ExpQty
                { 
                    get 
                    {
                        QuickFix.Fields.ExpQty val = new QuickFix.Fields.ExpQty();
                        GetField(val);
                        return val;
                    }
                    set { SetField(value); }
                ...
                public void Set(QuickFix.Fields.ExpQty val) 
                { 
                    this.ExpQty = val;
                }
                ...
                public bool IsSet(QuickFix.Fields.ExpQty val) 
                { 
                    return IsSetExpQty();
                }
                
                public bool IsSetExpQty() 
                { 
                    return IsSetField(Tags.ExpQty);
                }
