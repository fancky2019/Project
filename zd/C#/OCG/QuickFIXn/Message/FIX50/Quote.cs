...
namespace QuickFix
{
    namespace FIX50 
    {
        public class Quote : Message
        {
            ...
            public QuickFix.Fields.BidSwapPoints BidSwapPoints
            { 
                get 
                {
                    QuickFix.Fields.BidSwapPoints val = new QuickFix.Fields.BidSwapPoints();
                    GetField(val);
                    return val;
                }
                set { SetField(value); }
            ...
            public void Set(QuickFix.Fields.BidSwapPoints val) 
            { 
                this.BidSwapPoints = val;
            }
            
            public QuickFix.Fields.BidSwapPoints Get(QuickFix.Fields.BidSwapPoints val) 
            { 
                GetField(val);
                return val;
            }
            
            public bool IsSet(QuickFix.Fields.BidSwapPoints val) 
            { 
                return IsSetBidSwapPoints();
            }
            
            public bool IsSetBidSwapPoints() 
            { 
                return IsSetField(Tags.BidSwapPoints);
            }
            public QuickFix.Fields.OfferSwapPoints OfferSwapPoints
            { 
                get 
                {
                    QuickFix.Fields.OfferSwapPoints val = new QuickFix.Fields.OfferSwapPoints();
                    GetField(val);
                    return val;
                }
                set { SetField(value); }
            ...
            public void Set(QuickFix.Fields.OfferSwapPoints val) 
            { 
                this.OfferSwapPoints = val;
            }
            
            public QuickFix.Fields.OfferSwapPoints Get(QuickFix.Fields.OfferSwapPoints val) 
            { 
                GetField(val);
                return val;
            }
            
            public bool IsSet(QuickFix.Fields.OfferSwapPoints val) 
            { 
                return IsSetOfferSwapPoints();
            }
            
            public bool IsSetOfferSwapPoints() 
            { 
                return IsSetField(Tags.OfferSwapPoints);
            }
            ...
            public class NoLegsGroup : Group
            {
                ...
                public QuickFix.Fields.LegBidForwardPoints LegBidForwardPoints
                { 
                    get 
                    {
                        QuickFix.Fields.LegBidForwardPoints val = new QuickFix.Fields.LegBidForwardPoints();
                        GetField(val);
                        return val;
                    }
                    set { SetField(value); }
                ...
                public void Set(QuickFix.Fields.LegBidForwardPoints val) 
                { 
                    this.LegBidForwardPoints = val;
                }
                
                public QuickFix.Fields.LegBidForwardPoints Get(QuickFix.Fields.LegBidForwardPoints val) 
                { 
                    GetField(val);
                    return val;
                }
                
                public bool IsSet(QuickFix.Fields.LegBidForwardPoints val) 
                { 
                    return IsSetLegBidForwardPoints();
                }
                
                public bool IsSetLegBidForwardPoints() 
                { 
                    return IsSetField(Tags.LegBidForwardPoints);
                }
                public QuickFix.Fields.LegOfferForwardPoints LegOfferForwardPoints
                { 
                    get 
                    {
                        QuickFix.Fields.LegOfferForwardPoints val = new QuickFix.Fields.LegOfferForwardPoints();
                        GetField(val);
                        return val;
                    }
                    set { SetField(value); }
                ...
                public QuickFix.Fields.LegOfferForwardPoints Get(QuickFix.Fields.LegOfferForwardPoints val) 
                { 
                    GetField(val);
                    return val;
                }
                
                public bool IsSet(QuickFix.Fields.LegOfferForwardPoints val) 
                { 
                    return IsSetLegOfferForwardPoints();
                }
                
                public bool IsSetLegOfferForwardPoints() 
                { 
                    return IsSetField(Tags.LegOfferForwardPoints);
                }
