...
namespace QuickFix
{
    namespace FIX50 
    {
        public class PositionReport : Message
        {
            ...
            public QuickFix.Fields.ModelType ModelType
            { 
                get 
                {
                    QuickFix.Fields.ModelType val = new QuickFix.Fields.ModelType();
                    GetField(val);
                    return val;
                }
                set { SetField(value); }
            ...
            public void Set(QuickFix.Fields.ModelType val) 
            { 
                this.ModelType = val;
            }
            
            public QuickFix.Fields.ModelType Get(QuickFix.Fields.ModelType val) 
            { 
                GetField(val);
                return val;
            }
            
            public bool IsSet(QuickFix.Fields.ModelType val) 
            { 
                return IsSetModelType();
            }
            
            public bool IsSetModelType() 
            { 
                return IsSetField(Tags.ModelType);
            }
