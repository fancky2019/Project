    ...
    namespace FIX50 
    {
        public class ExecutionAcknowledgement : Message
        {
                ...
                ) : this()
            {
                ...
                this.ExecAckStatus = aExecAckStatus;
                this.ExecID = aExecID;
                this.Side = aSide;
            }
            ...
            public QuickFix.Fields.ExecAckStatus ExecAckStatus
            { 
                get 
                {
                    QuickFix.Fields.ExecAckStatus val = new QuickFix.Fields.ExecAckStatus();
                    GetField(val);
                    return val;
                }
                set { SetField(value); }
            ...
            public void Set(QuickFix.Fields.ExecAckStatus val) 
            { 
                this.ExecAckStatus = val;
            }
            
            public QuickFix.Fields.ExecAckStatus Get(QuickFix.Fields.ExecAckStatus val) 
            { 
                GetField(val);
                return val;
            }
            
            public bool IsSet(QuickFix.Fields.ExecAckStatus val) 
            { 
                return IsSetExecAckStatus();
            }
            
            public bool IsSetExecAckStatus() 
            { 
                return IsSetField(Tags.ExecAckStatus);
            }
