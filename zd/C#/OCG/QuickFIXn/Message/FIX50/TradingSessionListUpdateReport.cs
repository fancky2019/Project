...
namespace QuickFix
{
    namespace FIX50 
    {
        public class TradingSessionListUpdateReport : Message
        {
            ...
            {
                public static int[] fieldOrder = {Tags.TradingSessionID, Tags.TradingSessionSubID, Tags.SecurityExchange, Tags.MarketID, Tags.MarketSegmentID, Tags.TradingSessionDesc, Tags.TradSesMethod, Tags.TradSesMode, Tags.UnsolicitedIndicator, Tags.TradSesStatus, Tags.TradSesStatusRejReason, Tags.TradSesStartTime, Tags.TradSesOpenTime, Tags.TradSesPreCloseTime, Tags.TradSesCloseTime, Tags.TradSesEndTime, Tags.TotalVolumeTraded, Tags.NoOrdTypeRules, Tags.NoTimeInForceRules, Tags.NoExecInstRules, Tags.NoMatchRules, Tags.NoMDFeedTypes, Tags.Text, Tags.EncodedTextLen, Tags.EncodedText, Tags.TransactTime, Tags.TradSesUpdateAction, 0};
