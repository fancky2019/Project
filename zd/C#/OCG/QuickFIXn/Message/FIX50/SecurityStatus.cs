...
namespace QuickFix
{
    namespace FIX50 
    {
        public class SecurityStatus : Message
        {
            ...
            public QuickFix.Fields.SecurityStatus SecurityStatus1
            { 
                get 
                {
            ...
            public QuickFix.Fields.SecurityTradingEvent SecurityTradingEvent
            { 
                get 
                {
                    QuickFix.Fields.SecurityTradingEvent val = new QuickFix.Fields.SecurityTradingEvent();
                    GetField(val);
                    return val;
                }
                set { SetField(value); }
            ...
            public void Set(QuickFix.Fields.SecurityTradingEvent val) 
            { 
                this.SecurityTradingEvent = val;
            }
            
            public QuickFix.Fields.SecurityTradingEvent Get(QuickFix.Fields.SecurityTradingEvent val) 
            { 
                GetField(val);
                return val;
            }
            
            public bool IsSet(QuickFix.Fields.SecurityTradingEvent val) 
            { 
                return IsSetSecurityTradingEvent();
            }
            
            public bool IsSetSecurityTradingEvent() 
            { 
                return IsSetField(Tags.SecurityTradingEvent);
            }
