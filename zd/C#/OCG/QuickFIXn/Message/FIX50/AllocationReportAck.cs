...
namespace QuickFix
{
    namespace FIX50 
    {
        public class AllocationReportAck : Message
        {
            ...
            {
                public static int[] fieldOrder = {Tags.AllocAccount, Tags.AllocAcctIDSource, Tags.AllocPrice, Tags.AllocPositionEffect, Tags.IndividualAllocID, Tags.IndividualAllocRejCode, Tags.NoNestedPartyIDs, Tags.AllocText, Tags.EncodedAllocTextLen, Tags.EncodedAllocText, Tags.SecondaryIndividualAllocID, Tags.AllocCustomerCapacity, Tags.IndividualAllocType, Tags.AllocQty, 0};
