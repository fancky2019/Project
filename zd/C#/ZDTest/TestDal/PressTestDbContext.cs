...
namespace TestDal
{
    ...
    public class PressTestDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<TClientBaseInfo>().ToTable("TClientBaseInfo", "dbo").HasKey(t => t.FClientNo);
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder) => optionsBuilder.UseSqlServer(Configurations.Configuration["TestDal:PressTestConStr"]);
        ...
        public virtual DbSet<TClientBaseInfo> TClientBaseInfo { get; set; }
