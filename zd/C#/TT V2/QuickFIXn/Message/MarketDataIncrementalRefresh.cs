    ...
    namespace FIX42 
    {
        public class MarketDataIncrementalRefresh : Message
        {
            ...
            public class NoMDEntriesGroup : Group
            {
                ...
                public static int[] fieldOrder = {Tags.MDUpdateAction, Tags.Symbol, Tags.SecurityType, Tags.MaturityMonthYear, Tags.MaturityDay, Tags.PutOrCall, Tags.StrikePrice, Tags.OptAttribute, Tags.SecurityID, Tags.SecurityAltID, Tags.SecurityExchange, Tags.SettlType, Tags.MDEntryType, Tags.MDEntryPx, Tags.MDEntrySize, Tags.MDEntryBuyer, Tags.MDEntrySeller, Tags.MDEntryPositionNo, Tags.TotalVolumeTraded, Tags.SecondaryOrderID, Tags.MDEntryState, Tags.Currency, Tags.PriceFeedStatus, Tags.DeliveryTerm, Tags.AggressorSide, Tags.MDEntrySizeType, Tags.NumberOfOrders, Tags.ExactNumOrdersIndicator, Tags.TrdType, 0};
