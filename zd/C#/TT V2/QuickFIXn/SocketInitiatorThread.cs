...
namespace QuickFix
{
    ...
    public class SocketInitiatorThread : IResponder
    {
        ...
        public const int BUF_SIZE = 1024 * 5;
        ...
        public bool Read()
        {
            try
            {
                ...
                if (bytesRead > 0)
                {
                    //Changed by Rainer on 20141113 begin
                    //parser_.AddToStream(System.Text.Encoding.UTF8.GetString(readBuffer_, 0, bytesRead));
                    parser_.AddToParser(ref readBuffer_, 0, bytesRead);
                    //Changed by Rainer on 20141113 end
                }
