...
namespace TTMarketAdapter
{
    ...
    class Sub2Pumper
    {
        ...
        public static void pumpSnapshotQuickFast(OrderBookALL orderBookAll, string logHeader)
        {
            ...
            try
            {
                ...
                if (orderBookAll.franctionalBase != 0)//一直都是0，可注释
                {
    ...
    /// 消息类型对应的ASCII值
    /// </summary>
    public class ZDMDMsgTypeASCII
    {
        public const byte MarketData = 65;//A
        public const byte ImpliedData = 66;//B
        public const byte StatisticsData = 67;//C
        public const byte TradeData = 68;//D
        public const byte HeartBeat = 69;//E
        public const byte ClearData = 70;//F
    ...
    {
        public const string MarketData = "A";
        public const string ImpliedData = "B";
        public const string StatisticsData = "C";
        public const string TradeData = "D";
        public const string HeartBeat = "E";
        public const string ClearData = "F";
    }
    ...
    public class ZDMDMsgProtocol
    {
        ...
        public string FiveLevelLength { get; set; }
        public string OneLevelLength { get; set; }
        public UInt64 TimeStamp { get; set; }
        public string MsgBody { get; set; }

        public byte[] GetBytes()
        {
            byte[] bytes = new byte[MsgBody.Length + 12];
            bytes[0] = Encoding.ASCII.GetBytes(Edition)[0];
            bytes[1] = Encoding.ASCII.GetBytes(MsgType)[0];
            bytes[2] = Encoding.ASCII.GetBytes(FiveLevelLength)[0];
            bytes[3] = Encoding.ASCII.GetBytes(OneLevelLength)[0];
