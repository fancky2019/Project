            ...
            uperProductList.ForEach(u =>
            {
                ...
                foreach (var p in currentProductList)
                {
                    ...
                    try
                    {
                        ...
                        string contractSubName = string.Empty;
                        SecurityDefinition securityDefinition = CodeTransfer_TT.zd2TTMapping[p.zdCode];
                        var securityAltID = securityDefinition.SecurityAltID.getValue();
                        if (securityAltID == "Jun19 P53.00")
                        {
                        ...
                        switch (p.upperProduct)
                        {
                            ...
                            case "SB":
                                ...
                                ////期货合约
                                //string sbYear = dateStr.Substring(0, 2);
                                //int sbMonth = int.Parse(dateStr.Substring(2, 2));
